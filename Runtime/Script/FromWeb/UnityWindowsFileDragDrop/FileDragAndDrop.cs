...
public class FileDragAndDrop : MonoBehaviour
{
    ...
    public bool m_appFocus;
    public float m_focusTimer;
    private void OnApplicationFocus(bool focus)
    {
        if (focus != m_appFocus) { 
            ...
            m_focusTimer = 0;
#if  UNITY_EDITOR_WIN
            m_currentPathsHold = DragAndDrop.paths;
#endif
        }
    }
    ...
    public void Update()
    {
        ...
        if (m_focusTimer> 0.5f && paths != null && m_currentPathsHold!=null  &&  paths.Length == 0 && m_currentPathsHold.Length > 0) {
